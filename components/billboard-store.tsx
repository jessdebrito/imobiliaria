import { Billboard as BillboardStoreType } from "@/types";

import Link from "next/link";
import Button from "@/components/ui/button";

interface BillboardStoreProps {
  data: BillboardStoreType;
}

const BillboardStore: React.FC<BillboardStoreProps> = ({ data }) => {
  return (
    <section
      id="banner"
